...
# Category classification — uses product_type directly, no keyword matching

# —————————————————————————

def classify_line_item(item):
“”“Return the product_type for a line item, or None if excluded/blank.”””
...
“”“Return a sample of line items for debugging — shows product_type and classification.”””
samples = []
for order in orders:
for item in order.get(“line_items”, []):
samples.append({
...
if args.slack:
    ...
    # Debug: show sample line items with product_type
